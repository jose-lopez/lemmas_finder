...
Original file is located at
    https://colab.research.google.com/drive/1Q7-rFdKOb-5AHK_3SNkFqslxiJGQxK5f
"""

"""
# Run these lines on terminal to set the envoroment in order to execute the script.
...
# Getting the browser to consult and get the lemmas.
browser = get_browser()

"""

This cell process the *.csv files from the corpus folder producing
updated versions of them, saved in a folder named "processed";
warnings and logs for each *.csv file are generated and saved too,
in folders with that name.
